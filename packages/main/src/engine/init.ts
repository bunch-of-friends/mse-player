...
export function init() {
    DependencyContainer.setStreamTransport(new DashStreamTransport(DependencyContainer.getHttpHandler()));
    DependencyContainer.setAbr(new SimpleAbr(DependencyContainer.getHttpHandler()));
}
